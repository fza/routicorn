...
/**
 * Overrides express' res.redirect() so that it's possible to redirect to named routes. This method
 * is fully compatible to the express API. If the routeName (path) argument contains a '/' or a
 * route with this name does not exist, express' redirect will be called.
 *
